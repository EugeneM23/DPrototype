...
public class AttackAnimationBehaviour : StateMachineBehaviour
{
    public override void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        /*animator.GetComponent<ChaseComponent>().enabled = false;
        animator.GetComponent<PatrolComponent>().enabled = false;*/
    }

    public override void OnStateExit(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        /*animator.GetComponent<ChaseComponent>().enabled = true;
        animator.GetComponent<PatrolComponent>().enabled = true;*/
